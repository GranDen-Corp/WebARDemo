...
export const RED_MARKER_PATTERN = `${MARKER_FOLDER}/red.patt`;
export const GREEN_MARKER_PATTERN = `${MARKER_FOLDER}/green.patt`;
export const BLUE_MARKER_PATTERN = `${MARKER_FOLDER}/blue.patt`;
