...
export const BGM_FOLDER = `static/bgm/`;
export const BGM_FILE= `${BGM_FOLDER}bgm.ogg`;
export const VOICE1_FILE= `${BGM_FOLDER}voice1.wav`;
export const VOICE2_FILE= `${BGM_FOLDER}voice2.wav`;
export const VOICE3_FILE= `${BGM_FOLDER}voice3.wav`;